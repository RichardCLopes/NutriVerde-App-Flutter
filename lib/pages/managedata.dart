                  ...
                  child: ListTile(
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () async {
                        ...
                        // Buscar o documento correspondente na coleção 'allsensors' baseado na mesma data e hora, faz o ID
                        ...
                        if (snapshot.exists) {
                          ...
                          if ((snapshot.data() as Map<String, dynamic>).length == 1) {  // Se tiver apenas o campo removido
                            await allSensorsRef.delete();  // Excluir o documento inteiro se não houver mais campos
                          }
                        }
                      },
                    ),
